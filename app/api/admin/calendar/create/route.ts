...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const qs = new URLSearchParams({data: JSON.stringify(body.data)}).toString();
    const res = await callFrappe(`/api/method/school_os.api.calendar_api.create_event?${qs}`, {}, sid);
